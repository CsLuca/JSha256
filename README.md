...
Win32 GUI benchmark for Bitcoin-style `double-SHA256` optimization stages `V1..V15` plus GPU `G1/G2/G3/G4` scaffold runs.
...
- phase-1 entry points with `G1`, `G2`, `G3`, and `G4` benchmark rows when CUDA driver is detected
