...
Win32 GUI benchmark for Bitcoin-style `double-SHA256` optimization stages `V1..V15` plus GPU `G1..G5` scaffold runs.
...
- phase-1 entry points with `G1..G5` benchmark rows when CUDA driver is detected
